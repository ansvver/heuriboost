...
skills/heuriboost-rag/
  ...
  scripts/{common.py,inspect_rag_repo.py,validate_dataset.py,train_reranker.py,eval_reranker.py,regression_ledger.py,mine_case_sets.py,build_fiqa_csv.py,run_hpo.py,run_ablation.py}
